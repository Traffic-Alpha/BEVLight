...
traffic_flow_configs = {
    # 1. 稳定低密度 (X~0.35)
    "low_density": {
        '157863208#0.1590': [6, 4, 6, 5, 6],
        '252712271#0.589': [3, 4, 3, 4, 5],
        '-1106233488.150': [4, 5, 6, 4, 6],
    },

    # 2. 波动通勤 (时段错峰, X~0.55)
    "fluctuating_commuter": {
        '157863208#0.1590': [12, 10, 9, 6, 4],
        '252712271#0.589': [5, 6, 9, 11, 12],
        '-1106233488.150': [5, 7, 11, 7, 5],
    },

    # 3. 饱和高密度 (最难但可解, X~0.72)
    "high_density": {
        '157863208#0.1590': [13, 11, 13, 13, 12],
        '252712271#0.589': [10, 11, 9, 11, 12],
        '-1106233488.150': [11, 12, 13, 11, 13],
    },

    # 4. 随机扰动 (随机尖峰, X~0.68)
    "random_perturbation": {
        '157863208#0.1590': [18, 9, 8, 8, 8],
        '252712271#0.589': [8, 8, 18, 8, 8],
        '-1106233488.150': [7, 7, 7, 7, 15],
    },

    # 5. 递增需求 (主干道主导+递增, 支路≈主向40%)
    "increasing_demand": {
        '157863208#0.1590': [7, 11, 12, 16, 17],
        '252712271#0.589': [6, 10, 11, 13, 16],
        '-1106233488.150': [4, 5, 5, 6, 6],
    },
