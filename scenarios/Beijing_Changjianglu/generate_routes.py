...
traffic_flow_configs = {
    # 1. 稳定低密度 (X~0.35)
    "low_density": {
        '606446495#0.451': [8, 10, 7, 9, 11],
        '538625748.377': [10, 10, 7, 11, 11],
        '832511541#0.628': [11, 11, 7, 10, 9],
    },

    # 2. 波动通勤 (时段错峰, X~0.55)
    "fluctuating_commuter": {
        '606446495#0.451': [9, 12, 20, 12, 9],
        '538625748.377': [12, 12, 12, 12, 11],
        '832511541#0.628': [14, 13, 11, 7, 7],
    },

    # 3. 饱和高密度 (最难但可解, X~0.72)
    "high_density": {
        '606446495#0.451': [20, 18, 19, 19, 16],
        '538625748.377': [14, 16, 18, 15, 17],
        '832511541#0.628': [19, 17, 20, 18, 16],
    },
    ...
    "increasing_demand": {
        '606446495#0.451': [12, 16, 19, 23, 26],
        '832511541#0.628': [10, 14, 17, 21, 23],
        '538625748.377': [5, 8, 8, 9, 10],
    },
