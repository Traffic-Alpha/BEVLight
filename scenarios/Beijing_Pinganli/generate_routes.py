...
@LastEditTime: 2026-07-02 19:12:11
'''
...
traffic_flow_configs = {
    # 1. 稳定低密度 (X~0.35)
    "low_density": {
        '-156465481#3.628.100': [4, 5, 7, 4, 6],
        '169221931#0.91': [9, 9, 5, 7, 7],
        '156465483#0.660': [4, 6, 6, 5, 7],
        '33610069#0.1159': [7, 10, 7, 9, 6],
    },

    # 2. 波动通勤 (时段错峰, X~0.55)
    "fluctuating_commuter": {
        '-156465481#3.628.100': [13, 11, 9, 6, 5],
        '169221931#0.91': [6, 9, 12, 15, 17],
        '156465483#0.660': [6, 9, 14, 9, 6],
        '33610069#0.1159': [9, 9, 10, 10, 9],
    },

    # 3. 饱和高密度 (最难但可解, X~0.72)
    "high_density": {
        '-156465481#3.628.100': [14, 15, 11, 16, 10],
        '169221931#0.91': [19, 15, 16, 14, 19],
        '156465483#0.660': [11, 13, 9, 10, 10],
        '33610069#0.1159': [16, 13, 16, 14, 13],
    },

    # 4. 随机扰动 (随机尖峰, X~0.68)
    "random_perturbation": {
        '-156465481#3.628.100': [8, 6, 8, 7, 16],
        '169221931#0.91': [10, 21, 10, 8, 9],
        '156465483#0.660': [8, 8, 8, 16, 7],
        '33610069#0.1159': [20, 15, 13, 11, 9],
    },

    # 5. 递增需求 (主干道主导+递增, 支路≈主向40%)
    "increasing_demand": {
        '169221931#0.91': [10, 13, 17, 20, 22],
        '33610069#0.1159': [9, 12, 15, 18, 20],
        '-156465481#3.628.100': [5, 6, 6, 7, 9],
        '156465483#0.660': [5, 5, 6, 6, 7],
    },
