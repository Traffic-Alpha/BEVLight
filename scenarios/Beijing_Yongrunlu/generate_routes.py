...
traffic_flow_configs = {
    # 1. 稳定低密度 (X~0.35)
    "low_density": {
        '-588610201#2.87': [4, 6, 5, 7, 6],
        '588610204#0.116': [6, 3, 4, 4, 5],
        '588610201#0.932': [8, 8, 8, 8, 6],
        '-588610204#1.409': [3, 6, 6, 5, 5],
    },

    # 2. 波动通勤 (时段错峰, X~0.55)
    "fluctuating_commuter": {
        '-588610201#2.87': [6, 8, 11, 14, 16],
        '588610204#0.116': [6, 8, 13, 8, 6],
        '588610201#0.932': [10, 10, 11, 10, 9],
        '-588610204#1.409': [15, 13, 11, 8, 6],
    },

    # 3. 饱和高密度 (最难但可解, X~0.72)
    "high_density": {
        '-588610201#2.87': [14, 16, 14, 16, 15],
        '588610204#0.116': [13, 14, 13, 11, 13],
        '588610201#0.932': [14, 13, 15, 14, 16],
        '-588610204#1.409': [15, 13, 14, 13, 14],
    },

    # 4. 随机扰动 (随机尖峰, X~0.68)
    "random_perturbation": {
        '-588610201#2.87': [19, 8, 8, 8, 8],
        '588610204#0.116': [8, 8, 18, 8, 8],
        '588610201#0.932': [8, 8, 8, 8, 18],
        '-588610204#1.409': [6, 14, 6, 6, 5],
    },

    # 5. 递增需求 (主干道主导+递增, 支路≈主向40%)
    "increasing_demand": {
        '-588610201#2.87': [9, 12, 15, 18, 20],
        '588610201#0.932': [8, 11, 13, 16, 18],
        '588610204#0.116': [4, 6, 6, 7, 8],
        '-588610204#1.409': [4, 5, 6, 6, 7],
    },
