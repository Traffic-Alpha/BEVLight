...
traffic_flow_configs = {
    # 1. 稳定低密度 (X~0.35)
    "low_density": {
        '458749037#0.1098': [6, 6, 3, 5, 5],
        '471999771#0.1574': [3, 5, 4, 6, 6],
        '845412822.360': [5, 3, 6, 6, 5],
    },

    # 2. 波动通勤 (时段错峰, X~0.55)
    "fluctuating_commuter": {
        '458749037#0.1098': [6, 9, 14, 8, 6],
        '471999771#0.1574': [8, 8, 8, 8, 7],
        '845412822.360': [11, 10, 8, 6, 5],
    },

    # 3. 饱和高密度 (最难但可解, X~0.72)
    "high_density": {
        '458749037#0.1098': [12, 11, 12, 11, 10],
        '471999771#0.1574': [16, 13, 12, 14, 12],
        '845412822.360': [10, 11, 10, 11, 9],
    },

    # 4. 随机扰动 (随机尖峰, X~0.68)
    "random_perturbation": {
        '458749037#0.1098': [6, 12, 6, 5, 5],
        '471999771#0.1574': [6, 6, 6, 13, 6],
        '845412822.360': [15, 7, 7, 7, 7],
    },

    # 5. 递增需求 (主干道主导+递增, 支路≈主向40%)
    "increasing_demand": {
        '458749037#0.1098': [8, 11, 13, 15, 17],
        '845412822.360': [7, 9, 12, 13, 15],
        '471999771#0.1574': [4, 4, 4, 5, 7],
    },
