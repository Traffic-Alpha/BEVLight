...
traffic_flow_configs = {
    # 1. 稳定低密度 (X~0.35)
    "low_density": {
        '989312046#0': [9, 11, 8, 10, 8],
        '315156946#0': [10, 12, 9, 11, 13],
        '525074961#6': [10, 12, 14, 11, 13],
        'E1': [11, 9, 12, 10, 8],
    },

    # 2. 波动通勤 (时段错峰, X~0.55)
    "fluctuating_commuter": {
        '989312046#0': [9, 12, 20, 12, 9],
        '315156946#0': [14, 15, 16, 16, 14],
        '525074961#6': [22, 19, 15, 12, 9],
        'E1': [12, 16, 21, 27, 31],
    },

    # 3. 饱和高密度 (最难但可解, X~0.72)
    "high_density": {
        '989312046#0': [22, 24, 21, 23, 20],
        '315156946#0': [26, 28, 25, 27, 29],
        '525074961#6': [14, 16, 18, 15, 17],
        'E1': [22, 22, 18, 21, 21],
    },

    # 4. 随机扰动 (随机尖峰, X~0.68)
    "random_perturbation": {
        '989312046#0': [27, 13, 13, 13, 12],
        '315156946#0': [16, 16, 36, 15, 15],
        '525074961#6': [14, 14, 14, 14, 31],
        'E1': [15, 35, 15, 15, 15],
    },

    # 5. 递增需求 (主干道主导+递增, 支路≈主向40%)
    "increasing_demand": {
        '315156946#0': [16, 23, 28, 34, 37],
        '525074961#6': [15, 21, 24, 29, 34],
        '989312046#0': [8, 11, 11, 13, 15],
        'E1': [8, 10, 11, 11, 13],
    },
